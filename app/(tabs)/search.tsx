...
import { Chip, HeroPanel, InlineScroll, ScreenHeader, SectionBlock, VisualCard } from '../../src/ui/lived-in';
...
export default function SearchScreen() {
  ...
  return (
    <Screen>
      ...
      <SectionBlock eyebrow="Résultats" title={query ? 'Ce qui sort' : 'A ouvrir'}>
      ...
      {!!data.followedOrganizerEvents?.length && (
        <SectionBlock eyebrow="Follow" title="Créateurs suivis">
          <View style={styles.stack}>
