...
export default function CheckoutSessionPage() {
  ...
  if (loading) {
    return (
      <Screen bleed scroll={false} contentStyle={styles.centerState}>
        <View>
    ...
    <Screen bleed>
      ...
      <View style={styles.summaryCard}>
        <View style={styles.summaryHeader}>
          <TicketIcon size={18} color={colors.orangeInk} />
...
const styles = StyleSheet.create({
  ...
  providerPillText: { fontFamily: typography.fontFamily.medium, fontSize: typography.fontSize.xs, color: colors.orangeInk, textTransform: 'uppercase', letterSpacing: 1.5 },
  heroCard: { padding: 20, borderRadius: 28, backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, gap: 10 },
  eyebrow: { fontFamily: typography.fontFamily.medium, fontSize: typography.fontSize.xs, color: colors.orangeInk, textTransform: 'uppercase', letterSpacing: 2.1 },
  ...
  stateBadgeText: { fontFamily: typography.fontFamily.medium, fontSize: typography.fontSize.xs, color: colors.orangeInk, textTransform: 'uppercase', letterSpacing: 1.2 },
  ...
  secondaryButtonText: { color: colors.orangeInk, fontFamily: typography.fontFamily.bold, fontSize: typography.fontSize.sm },
